...
class TestTC01():
  ...
  def test_tC01(self):
    ...
    self.driver.find_element(By.ID, "email").send_keys("agilkrisna01@gmail.com")
    # 5 | type | id=mobilePhone | 081211806728
    self.driver.find_element(By.ID, "mobilePhone").send_keys("085156360536")
    # 6 | click | id=password | 
    ...
    self.driver.find_element(By.ID, "firstName").send_keys("Agil")
    # 12 | click | id=lastName | 
    self.driver.find_element(By.ID, "lastName").click()
    # 13 | type | id=lastName | Diapari
    self.driver.find_element(By.ID, "lastName").send_keys("Krisna Tripujianto")
    ...
    self.driver.find_element(By.ID, "cityAndProvince").send_keys("KOTA TANGERANG")
    ...
    self.driver.find_element(By.ID, "pin-input-0").send_keys("1")
    # 24 | type | id=pin-input-1 | 0
    self.driver.find_element(By.ID, "pin-input-1").send_keys("7")
    # 25 | type | id=pin-input-2 | 3
    self.driver.find_element(By.ID, "pin-input-2").send_keys("0")
    ...
    self.driver.find_element(By.ID, "pin-input-5").send_keys("6")
